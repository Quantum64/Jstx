...
import co.q64.jstx.compression.lzma.impl.coder.BitTreeDecoder;
import co.q64.jstx.compression.lzma.impl.lz.OutWindow;
...
public class Decoder {
	class LenDecoder {
		...
		public void Init() {
			co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode(co.q64.jstx.compression.lzma.impl.coder.Decoder rangeDecoder, int posState) throws IOException {
	...
	class LiteralDecoder {
		class Decoder2 {
			...
			public void Init() {
				co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_Decoders);
			}

			public byte DecodeNormal(co.q64.jstx.compression.lzma.impl.coder.Decoder rangeDecoder) throws IOException {
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(co.q64.jstx.compression.lzma.impl.coder.Decoder rangeDecoder, byte matchByte) throws IOException {
				int symbol = 1;
				do {
	...
	co.q64.jstx.compression.lzma.impl.coder.Decoder m_RangeDecoder = new co.q64.jstx.compression.lzma.impl.coder.Decoder();
	...
	void Init() throws IOException {
		...
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsMatchDecoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsRepDecoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsRepG0Decoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsRepG1Decoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_IsRepG2Decoders);
		co.q64.jstx.compression.lzma.impl.coder.Decoder.InitBitModels(m_PosDecoders);

...
public class AceSelection {
	...
	private static native void registerRootListener(JavaScriptObject selection, AceSelectionListener rootListener) /*-{
		selection.addEventListener("changeSelection", function() {
			rootListener.@co.q64.jstx.gwt.ui.ace.AceSelectionListener::onChangeSelection(Lco/q64/jstx/gwt/ui/ace/AceSelection;)(null);
		});
	}-*/;
	...
	public native boolean isEmpty() /*-{
		return this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.isEmpty();
	}-*/;
	...
	public native boolean isMultiLine() /*-{
		return this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.isMultiLine();
	}-*/;
	...
	public native AceEditorCursorPosition getSelectionLead() /*-{
		var pos = this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.getSelectionLead();
		return this.@co.q64.jstx.gwt.ui.ace.AceSelection::getCursorPositionImpl(DD)(pos.row, pos.column);
	}-*/;
	...
	public native AceEditorCursorPosition getSelectionAnchor() /*-{
		var pos = this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.getSelectionAnchor();
		return this.@co.q64.jstx.gwt.ui.ace.AceSelection::getCursorPositionImpl(DD)(pos.row, pos.column);
	}-*/;
	...
	public native boolean isBackwards() /*-{
		return this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.isBackwards();
	}-*/;
	...
	public native void clearSelection() /*-{
		this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.clearSelection();
	}-*/;
	...
	public native void selectAll() /*-{
		this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.selectAll();
	}-*/;
	...
	public native void select(int fromRow, int fromColumn, int toRow, int toColumn) /*-{
		this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.setSelectionAnchor(fromRow, fromColumn);
		this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection.selectTo(toRow, toColumn);
	}-*/;
	...
	public native void selectLine() /*-{
		var s = this.@co.q64.jstx.gwt.ui.ace.AceSelection::selection;

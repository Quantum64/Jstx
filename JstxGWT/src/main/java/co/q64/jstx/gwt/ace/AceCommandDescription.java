...
public class AceCommandDescription {
	...
	public static native AceCommandDescription fromJavaScript(JavaScriptObject obj) /*-{
		var name = obj.name;
		var exec = @co.q64.jstx.gwt.ace.AceCommandDescription::createJavaScriptWrapper(Ljava/lang/Object;)(obj.exec);
		var ret = @co.q64.jstx.gwt.ace.AceCommandDescription::new(Ljava/lang/String;Lco/q64/jstx/gwt/ace/AceCommandDescription$ExecAction;)(name, exec);
		var bindKey = @co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::fromJavaScript(Ljava/lang/Object;)(obj.bindKey);
		if (bindKey)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withBindKey(Lco/q64/jstx/gwt/ace/AceCommandDescription$KeyBinding;)(bindKey);
		var readOnly = obj.readOnly;
		if (readOnly)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withReadOnly(Z)(readOnly);
		var passEvent = obj.passEvent;
		if (passEvent)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withPassEvent(Z)(passEvent);
		var scrollIntoView = @co.q64.jstx.gwt.ace.AceCommandDescription.ScrollIntoView::fromString(Ljava/lang/String;)(obj.scrollIntoView);
		if (scrollIntoView)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withScrollIntoView(Lco/q64/jstx/gwt/ace/AceCommandDescription$ScrollIntoView;)(scrollIntoView);
		var objMultiSelectAction = obj.multiSelectAction;
		var multiSelectAction = null;
		if (typeof objMultiSelectAction === "string")
			multiSelectAction = @co.q64.jstx.gwt.ace.AceCommandDescription.MultiSelectAction::fromString(Ljava/lang/String;)(objMultiSelectAction);
		if (multiSelectAction)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withMultiSelectAction(Lco/q64/jstx/gwt/ace/AceCommandDescription$MultiSelectAction;)(multiSelectAction);
		var aceCommandGroup = obj.aceCommandGroup;
		if (aceCommandGroup)
			ret.@co.q64.jstx.gwt.ace.AceCommandDescription::withAceCommandGroup(Ljava/lang/String;)(aceCommandGroup);
		return ret;
	}-*/;
	...
	private static native Object invokeJavaScriptCommand(Object jsFunction, AceEditor javaWrapper) /*-{
		var jsEditor = javaWrapper.@co.q64.jstx.gwt.ace.AceEditor::editor;
	...
	public native JavaScriptObject toJavaScript(AceEditor editor) /*-{
		var ret = {};
		ret['name'] = this.@co.q64.jstx.gwt.ace.AceCommandDescription::name;
		var javaExec = this.@co.q64.jstx.gwt.ace.AceCommandDescription::exec;
		ret['exec'] = function() {
			javaExec.@co.q64.jstx.gwt.ace.AceCommandDescription.ExecAction::exec(Lco/q64/jstx/gwt/ace/AceEditor;)(editor);
		};
		var bindKey = this.@co.q64.jstx.gwt.ace.AceCommandDescription::bindKey;
		if (bindKey)
			ret['bindKey'] = bindKey.@co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::toJavaScript()();
		var readOnly = this.@co.q64.jstx.gwt.ace.AceCommandDescription::readOnly;
		if (readOnly)
			ret['readOnly'] = readOnly;
		var passEvent = this.@co.q64.jstx.gwt.ace.AceCommandDescription::passEvent;
		if (passEvent) 
			ret['passEvent'] = passEvent;
		var scrollIntoView = this.@co.q64.jstx.gwt.ace.AceCommandDescription::scrollIntoView;
		if (scrollIntoView)
			ret['scrollIntoView'] = scrollIntoView.@co.q64.jstx.gwt.ace.AceCommandDescription.ScrollIntoView::name()();
		var multiSelectAction = this.@co.q64.jstx.gwt.ace.AceCommandDescription::multiSelectAction;
		if (multiSelectAction)
			ret['multiSelectAction'] = multiSelectAction.@co.q64.jstx.gwt.ace.AceCommandDescription.MultiSelectAction::name()();
		var aceCommandGroup = this.@co.q64.jstx.gwt.ace.AceCommandDescription::aceCommandGroup;
		if (aceCommandGroup)
	...
	public static class KeyBinding {
		...
		private static native KeyBinding fromJavaScript(Object obj) /*-{
			...
			if (typeof obj === "string")
				return @co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::new(Ljava/lang/String;)(obj);
			return @co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::new(Ljava/lang/String;Ljava/lang/String;)(obj.win, obj.mac);
		}-*/;

		private native Object toJavaScript() /*-{
			var ret = this.@co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::allPlatforms;
			if (ret)
				return ret;
			var win = this.@co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::exceptMac;
			var mac = this.@co.q64.jstx.gwt.ace.AceCommandDescription.KeyBinding::mac;
